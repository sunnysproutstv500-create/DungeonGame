...
assert(appSource.includes('STITCH_THEME'), 'smoke: mobile app has Stitch visual theme tokens');
...
assert(appSource.includes('Begin Trial'), 'smoke: setup screen starts the configured trial');
